...
If you are working with geographic data from Malawi, or are making a workflow for analyzing land cover change, you may find the guide below helpful. For a more detailed documentation of my data sources, projections, and other minutae, you can refer to the appendix of my [paper](./agriculture-population-malawi.pdf). I am also including some SQL code snippets in this repo, which you could use as a guide when you clean and merge your data.
