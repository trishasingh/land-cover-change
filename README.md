# Analyzing land cover change using open-source geographic information system

I conducted research on the effect of population density on agricultural land use and nutritional outcomes in Malawi from 1998 to 2008 for a phenomenal class in college titled [Open GIS for the Developing World](http://www.josephholler.com/open-gis-for-the-developing-world/) taught by Professor Joe Holler. You can find my research [here](./agriculture-population-malawi.pdf). For this project, I obtained land cover data using Landsat 5 satellite imaging, classified the images using k-means clustering, and then aggregated land cover change between 1998 and 2008 by districts. Some of the open-source software and tools I used were: SAGA, GRASS, QGIS, SQLite, and Google Earth.

If you are working with geographic data from Malawi, or are making a workflow for analyzing land cover change, you may find the guide below helpful. For a more detailed documentation of my data sources, projections, and other minutae, you can refer to the appendix of my [paper](./agriculture-population-malawi.pdf). I am also including some SQL code snippets in this repo, which you could use as a guide when you clean and merge your data. I queried the data using SQLite through QGIS.

In the workflow below, I refer to the [techincal manual](http://www.josephholler.com/files/GIS4DEV.pdf) from Professor Holler's website. This workflow has the following steps:

* [Obtain Remote Sensing Data](#obtain-remote-sensing-data)
* [Write up Metadata for Granules](#write-up-metadata)
* [Correct the Images](#correct-images)
* [Unsupervised Classification](#unsupervised-classification)
* [Create Training Areas for Supervised Classification](#create-training-areas)
* [Supervised Classification](#supervised-classification)
* [Assess Accuracy of Land Cover Classification](#assess-accuracy)
* [Detect Land Change](#detect-change)
* [Summarize Change by Polygons](#summarize-change)
* [Notes](#notes)
